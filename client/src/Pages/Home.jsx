...
export default function Home() {
  ...
  return (
    ...
    <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        Discover your dream home with PropertyFinder, the ultimate destination for 
        <br/>
        ...
        <Link
          to={'/search'}
          className='text-xs sm:text-sm text-gray-900 font-bold hover:underline'
        >
          Let's get started...
        </Link>
      </div>
      ...
      {/* listing results of rent, offer and slae */}
